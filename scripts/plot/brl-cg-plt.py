...
poshis2 = sp.genfromtxt('../entrada/brl/saida1.1/CurvaGiro/pos.dat')
poshis3 = sp.genfromtxt('../entrada/brl/saida1.2/CurvaGiro/pos.dat')
poshis4 = sp.genfromtxt('../entrada/brl/saida1.3/CurvaGiro/pos.dat')
