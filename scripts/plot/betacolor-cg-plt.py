...
poshis2 = sp.genfromtxt('../entrada/beta/saida1.1/CurvaGiro/pos.dat')
poshis3 = sp.genfromtxt('../entrada/beta/saida1.2/CurvaGiro/pos.dat')
poshis4 = sp.genfromtxt('../entrada/beta/saida1.3/CurvaGiro/pos.dat')
...
plt.plot(poshis[:, 2],  poshis[:, 1],  'k--', 
label=ur'padrão')
plt.plot(poshis2[:, 2],  poshis2[:, 1],  'k-',
label=ur'1.1beta')
plt.plot(poshis3[:, 2],  poshis3[:, 1],  'k.',
label=ur'1.2beta')
