...
acelhis2 = sp.genfromtxt('../entrada/beta/saida1.2/CurvaZigZag/acel.dat')
acelhis3 = sp.genfromtxt('../entrada/r/saida1.2/CurvaZigZag/acel.dat')
acelhis4 = sp.genfromtxt('../entrada/leme/saida1.2/CurvaZigZag/acel.dat')
acelhis5 = sp.genfromtxt('../entrada/brl/saida1.2/CurvaZigZag/acel.dat')
...
plt.scatter(somep(acelhis3[:, 0], num = 200), somep(acelhis3[:, 2], num =
200), 
color = rc, marker = rs, s = 8, label=ur'1.2r')
plt.scatter(somep(acelhis4[:, 0], num = 100),  somep(acelhis4[:, 2], num =
100), 
color = lc, marker = ls, s = 20, label=ur'1.2leme')
plt.scatter(somep(acelhis5[:, 0], num = 100), somep(acelhis5[:, 2], num =
100), 
