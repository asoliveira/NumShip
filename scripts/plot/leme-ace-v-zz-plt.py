...
acelhis2 = sp.genfromtxt('../entrada/leme/saida1.1/CurvaZigZag/acel.dat')
acelhis3 = sp.genfromtxt('../entrada/leme/saida1.2/CurvaZigZag/acel.dat')
acelhis4 = sp.genfromtxt('../entrada/leme/saida1.3/CurvaZigZag/acel.dat')

lemehis = sp.genfromtxt('../entrada/padrao/CurvaZigZag/leme.dat')
lemehis2 = sp.genfromtxt('../entrada/leme/saida1.1/CurvaZigZag/leme.dat')
lemehis3 = sp.genfromtxt('../entrada/leme/saida1.2/CurvaZigZag/leme.dat')
lemehis4 = sp.genfromtxt('../entrada/leme/saida1.3/CurvaZigZag/leme.dat')

axl = [0, 1000, -0.03, 0.03]
