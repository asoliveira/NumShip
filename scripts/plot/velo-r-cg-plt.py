...
ps,linewidth = 1, label=ur'$M1$')
plt.plot(velohis2[:, 0],  velohis2[:, 6] *(180/sp.pi),  color = bc,linestyle
= bs, linewidth = 1, label=ur'1.2$\beta$')
plt.plot(velohis3[:, 0], velohis3[:, 6]*(180/sp.pi), 
color = rc, linestyle = rs, label=ur'1.2r')
plt.plot(velohis4[:, 0], velohis4[:, 6] *(180/sp.pi), 
color = lc, linestyle = ls,  label=ur'1.2$\delta_R$')
plt.plot(velohis5[:, 0], velohis5[:, 6] *(180/sp.pi), 
