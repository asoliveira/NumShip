...
etahis = sp.genfromtxt('../entrada/padrao/CurvaZigZag/eta.dat')
etahis2 = sp.genfromtxt('../entrada/beta/saida1.2/CurvaZigZag/eta.dat')
etahis3 = sp.genfromtxt('../entrada/r/saida1.2/CurvaZigZag/eta.dat')
etahis4 = sp.genfromtxt('../entrada/leme/saida1.2/CurvaZigZag/eta.dat')
etahis5 = sp.genfromtxt('../entrada/brl/saida1.2/CurvaZigZag/eta.dat')
