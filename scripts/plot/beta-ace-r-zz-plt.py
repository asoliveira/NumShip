...
acelhis2 = sp.genfromtxt('../entrada/beta/saida1.1/CurvaZigZag/acel.dat')
acelhis3 = sp.genfromtxt('../entrada/beta/saida1.2/CurvaZigZag/acel.dat')
acelhis4 = sp.genfromtxt('../entrada/beta/saida1.3/CurvaZigZag/acel.dat')
