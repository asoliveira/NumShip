...
plt.plot(acelhis2[:, 0],  acelhis2[:, 1],  color = bc,linestyle = bs,
linewidth = 2, label=ur'1.2beta')
plt.scatter(somep(acelhis3[:, 0], num = 200), somep(acelhis3[:, 1], num =
200), 
color = rc, marker = rs, s = 8, label=ur'1.2r')
plt.scatter(somep(acelhis4[:, 0], num = 100),  somep(acelhis4[:, 1], num =
100), 
color = lc, marker = ls, s = 20, label=ur'1.2leme')
plt.scatter(somep(acelhis5[:, 0], num = 100), somep(acelhis5[:, 1], num =
100), 
