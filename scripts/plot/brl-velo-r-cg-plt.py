...
velohis2 = sp.genfromtxt('../entrada/brl/saida1.1/CurvaGiro/velo.dat')
velohis3 = sp.genfromtxt('../entrada/brl/saida1.2/CurvaGiro/velo.dat')
velohis4 = sp.genfromtxt('../entrada/brl/saida1.3/CurvaGiro/velo.dat')
