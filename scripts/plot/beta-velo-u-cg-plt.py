...
acehis2 = sp.genfromtxt('../entrada/beta/saida1.1/CurvaGiro/velo.dat')
acehis3 = sp.genfromtxt('../entrada/beta/saida1.2/CurvaGiro/velo.dat')
acehis4 = sp.genfromtxt('../entrada/beta/saida1.3/CurvaGiro/velo.dat')
