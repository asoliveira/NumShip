...
acehis2 = sp.genfromtxt('../entrada/leme/saida1.1/CurvaGiro/acel.dat')
acehis3 = sp.genfromtxt('../entrada/leme/saida1.2/CurvaGiro/acel.dat')
acehis4 = sp.genfromtxt('../entrada/leme/saida1.3/CurvaGiro/acel.dat')

axl = [0, 1000, -0.005, 0.035]
...
linestyle= r1s, linewidth = 1, label=ur'1.1leme')

plt.plot(acehis3[:, 0], acehis3[:, 6] * (180 / sp.pi), color = r2c, 
linewidth = 1, linestyle = r2s, label=ur'1.2leme')

plt.plot(acehis4[:, 0], acehis4[:, 6] * (180 / sp.pi),color = r3c, 
linestyle = r3s, linewidth = 1, label=ur'1.3leme')
plt.title(titulo)
