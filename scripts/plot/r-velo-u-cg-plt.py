...
acehis2 = sp.genfromtxt('../entrada/r/saida1.1/CurvaGiro/velo.dat')
acehis3 = sp.genfromtxt('../entrada/r/saida1.2/CurvaGiro/velo.dat')
acehis4 = sp.genfromtxt('../entrada/r/saida1.3/CurvaGiro/velo.dat')
