...
acehis2 = sp.genfromtxt('../entrada/r/saida1.1/CurvaGiro/eta.dat')
acehis3 = sp.genfromtxt('../entrada/r/saida1.2/CurvaGiro/eta.dat')
acehis4 = sp.genfromtxt('../entrada/r/saida1.3/CurvaGiro/eta.dat')
