...
acelhis2 = sp.genfromtxt('../entrada/brl/saida1.1/CurvaGiro/acel.dat')
acelhis3 = sp.genfromtxt('../entrada/brl/saida1.2/CurvaGiro/acel.dat')
acelhis4 = sp.genfromtxt('../entrada/brl/saida1.3/CurvaGiro/acel.dat')

axl = [0, 1000, -0.045, 0.0]
