...
poshis2 = sp.genfromtxt('../entrada/leme/saida1.1/CurvaZigZag/pos.dat')
poshis3 = sp.genfromtxt('../entrada/leme/saida1.2/CurvaZigZag/pos.dat')
poshis4 = sp.genfromtxt('../entrada/leme/saida1.3/CurvaZigZag/pos.dat')
...
linewidth = 1, label=ur'1.1$\delta_R$')
...
linewidth = 1, label = ur'1.2$\delta_R$')
